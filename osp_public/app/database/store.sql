...
--
-- Хост: MySQL-8.4:3306
-- Время создания: Июн 09 2026 г., 23:37
...
(322, 'Внешний жесткий диск 2TB', NULL, 50, 6000, 5, 1, 1, '2026-06-09'),
(323, 'USB-хаб', NULL, 65, 900, 3, 1, 0, '2026-06-09'),
(324, 'Bluetooth адаптер', NULL, 55, 1500, 4, 1, 1, '2026-06-09'),
(325, 'Настольный микрофон', NULL, 30, 4200, 6, 1, 1, '2026-06-09'),
(326, 'Wi-Fi адаптер', NULL, 40, 2000, 4, 1, 1, '2026-06-09'),
...
(344, 'Блузка летняя', NULL, 65, 2800, 4, 2, 2, '2026-06-09'),
(345, 'Трикотажные штаны', NULL, 55, 3300, 6, 2, 2, '2026-06-09'),
(346, 'Носки шерстяные', NULL, 150, 200, 1, 2, 1, '2026-06-09'),
...
(364, 'Летние сабо', NULL, 40, 2500, 2, 3, 1, '2026-06-09'),
...
(380, 'Обогреватель', NULL, 20, 6000, 13, 4, 1, '2026-06-09'),
...
(399, 'Массажный ролл', NULL, 40, 1500, 2, 5, 1, '2026-06-09'),
...
(418, 'Клей-карандаш', NULL, 70, 300, 1, 6, 1, '2026-06-09'),
...
(437, 'Погремушка', NULL, 80, 700, 2, 7, 1, '2026-06-09'),
...
(470, 'USB-хаб на 4 порта', NULL, 60, 1800, 6, 9, 2, '2026-06-09'),
...
(484, 'Ковровая дорожка', NULL, 30, 3500, 10, 10, 1, '2026-06-09'),
...
(498, 'Гигиеническая помада', NULL, 85, 600, 7, 11, 1, '2026-06-09'),
...
(503, 'Набор для тенниса', NULL, 30, 7000, 12, 13, 1, '2026-06-09'),
...
(508, 'Комплект для йоги', NULL, 50, 3000, 5, 11, 1, '2026-06-09'),
...
(523, 'Терка для овощей', NULL, 80, 900, 8, 15, 1, '2026-06-09'),
(524, 'Миксер ручной', NULL, 25, 2500, 14, 15, 1, '2026-06-09'),
(525, 'Сито металлическое', NULL, 60, 800, 9, 15, 1, '2026-06-09'),
(526, 'Формы для выпечки', NULL, 45, 1500, 11, 15, 1, '2026-06-09'),
(527, 'Кастрюля', NULL, 12, 6000, 13, 15, 1, '2026-06-09'),
(528, 'Термос', NULL, 20, 1800, 17, 15, 2, '2026-06-09');
...
(21, 326, '202606092305310.jpg'),
(22, 325, '202606092306040.jpg'),
(23, 346, '202606092306580.jpg'),
(24, 528, '202606092307300.jpg'),
(25, 527, '202606092307490.jpg'),
(26, 526, '202606092308120.jpg'),
(27, 525, '202606092308340.webp'),
(28, 524, '202606092308550.jpg'),
(29, 523, '202606092309290.jpg'),
(30, 324, '202606092310250.jpg'),
(31, 322, '202606092310550.jpg'),
(32, 345, '202606092315200.jpg'),
(33, 344, '202606092315400.webp'),
(34, 380, '202606092320140.webp'),
(35, 399, '202606092321030.jpg'),
(36, 437, '202606092321240.jpg'),
(37, 364, '202606092322520.jpg'),
(38, 498, '202606092323300.jpg'),
(39, 484, '202606092325330.webp'),
(40, 418, '202606092326530.jpg'),
(41, 508, '202606092328320.jpg'),
(42, 503, '202606092329270.jpg');
...
--
ALTER TABLE `items_images`
  MODIFY `id_items_images` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `items_type`
  MODIFY `id_items_type` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
